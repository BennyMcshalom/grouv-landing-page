...
export default function Hero() {
  return (
    <section className="hero">
      ...
      <h1 className="reveal">
        Meet your<br /><em>right-now people.</em>
      </h1>
      <p className="lead reveal">
        A social world organized around the life you&rsquo;re actually living, not the image you&rsquo;re projecting.
      </p>
      <a className="hero-cta" href="#join">Enter your space <span>↗</span></a>
      <FallingPills />
